...
class GuardAuthenticatorHandlerTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testHandleAuthenticationSuccess()
    {
        ...
        $handler = new GuardAuthenticatorHandler($this->tokenStorage, $this->dispatcher);
        $actualResponse = $handler->handleAuthenticationSuccess($this->guardAuthenticator, $this->request, $this->token, $providerKey);
    ...
    protected function setUp()
    {
        ...
        $this->guardAuthenticator = $this->getMock('Symfony\Component\Security\Core\Authentication\GuardAuthenticatorInterface');
    }
